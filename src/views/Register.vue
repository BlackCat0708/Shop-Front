  ...
  b-row
    ...
    b-col(cols='12')
      b-form(@submit.prevent="register")
        ...
        b-form-group(label='密碼' label-for='input-password' description='密碼長度為 4 到 20 個字' :state="state.password" invalid-feeback="密碼格式不正確")
          b-form-input#input-password(v-model="form.password" required placeholder='請輸入密碼' type='password' :state="state.password")
        b-form-group(label='信箱' label-for='input-email' description='信箱長度為 4 到 20 個字' :state="state.email" invalid-feedback="信箱格式不正確")
